...
<article id="first_section">
        ...
        <section class="bistec-suporte">
            ...
            <div class="redes-sociais">
                <a href="https://api.whatsapp.com/send?phone=5513992101945" title="Bistec Whatsapp" target="_blank"><ion-icon name="mail" class="ionspecial"></ion-icon></a>
                <a href="https://t.me/BISTEC_BOT" title="Bistec Telegram" target="_blank"><ion-icon name="logo-facebook"></ion-icon></a>
            </div>
